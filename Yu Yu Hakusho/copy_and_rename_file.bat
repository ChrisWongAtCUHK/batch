...
@REM usage: copy_and_rename_file.bat "destination_path" "extension" "file_name"
@REM example: copy_and_rename_file.bat "tmp" "txt" "tmp.txt"
...
REM    copy "%src%" "%dst%\!grapstring!.%ext%"
:reset
    set continue=n
    set grapstring=
:noprintgrapstring
